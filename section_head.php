...
<head>
    ...
    <script>(function (w, d, s, l, i) {
        ...
        })(window, document, 'script', 'dataLayer', 'GTM-MSC3NSD');</script>
...
<body>
    ...
    <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-MSC3NSD" height="0" width="0"
            style="display:none;visibility:hidden"></iframe></noscript>
    <!-- End Google Tag Manager (noscript) -->

    <nav class="navbar">
        <a href="index.php" class="logo">
            <img src="images/iso-macbuho.svg" alt="Macbuho logo"> MacBuho
        </a>
        ...
        <ul class="nav-links">
            ...
            <!-- <li class="nav-item"><a href="apple_watch.php"><img class="ripley" src="https://www.bancoripley.com.pe/img/svg/logo-r.svg">Ripley</a></li> -->

            <li class="nav-item whatsapp"><a href="https://wa.me/51958957066" target="_blank">
                    <svg viewBox="0 0 23 25" stroke="#fff" class="svgicon-chat" role="img" aria-hidden="true"
                    ...
                    958 957 066 <span>Cotiza tu mac</span></a>
            </li>

            <div class="nav-item">
                <input type="checkbox" id="active">
                <label for="active" class="hamburger-lines">
